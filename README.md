# Pookemon-
Pookemon Website is based On React JS and fetch API 
...
There were several challenges in these mini projects that we handled and learn how to fetch complext data from API. 

![18](https://github.com/user-attachments/assets/14a0bbd3-db02-4935-952b-3e5bcf109153)
...
* how to use differnt hooks in react js
* how to perform fetch in react js application
